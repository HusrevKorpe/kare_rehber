...
export default async function VeliGorusmelerSayfasi() {
  const gorusmeler = await gorusmeleriListele();
  return (
    <div className="mx-auto max-w-3xl px-6 py-8">
      <h1 className="text-2xl font-semibold">Çocuğumun görüşmeleri</h1>
      <p className="mt-1 text-sm text-slate-600">
        Çocuğunuzun koç ile yaptığı onaylı görüşme kayıtları.
      </p>
